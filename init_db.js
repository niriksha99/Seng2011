...
function create_tables() {
	...
	basic_query("CREATE TABLE Requests (id INT AUTO_INCREMENT PRIMARY KEY, userID INT, event_name VARCHAR(255), event_date DATE, event_time TIME, deadline DATE, suburb VARCHAR(255), event_type VARCHAR(255), no_people INT, food_quality VARCHAR(255), budget FLOAT(10,2), choice VARCHAR(255), additional_info VARCHAR(255), last_modified DATETIME, status int(1), FOREIGN KEY (userID) REFERENCES Users(id)) ", "created Requests table");
