...
function create_tables() {
	...
	basic_query("CREATE TABLE Businesses (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255), userID INT, opening_hours VARCHAR(255), phone_no VARCHAR(20), email VARCHAR(255), description VARCHAR(255), fame FLOAT(10,2), FOREIGN KEY (userID) REFERENCES Users(id))", "created Businesses table");	// link userID to Users(id)
