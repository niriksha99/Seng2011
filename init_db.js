...
function create_tables() {
	...
	basic_query("CREATE TABLE Businesses (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255), userID INT, opening_time TIME, closing_time TIME,  phone_no VARCHAR(20), email VARCHAR(255), address VARCHAR(255), description VARCHAR(255), events_cater VARCHAR(255), delivery_options VARCHAR(255), FOREIGN KEY (userID) REFERENCES Users(id))", "created Businesses table");	// link userID to Users(id)
