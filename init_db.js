...
function create_tables() {
	...
	basic_query("CREATE TABLE Requests (id INT AUTO_INCREMENT PRIMARY KEY, userID INT, event_name VARCHAR(255), date DATE, time TIME, deadline DATE, suburb VARCHAR(255), type VARCHAR(255), noPeople INT, qualityLevel VARCHAR(255), budget FLOAT(10,2), choice VARCHAR(255), additional_info VARCHAR(255), completed INT, FOREIGN KEY (userID) REFERENCES Users(id)) ", "created Requests table");
